    ...
    <>
      <div className=" py-10 cursor-pointer  lg:w-[200px] md:w-[90px]">
        ...
        <button className="hover:opacity-50 flex gap-[20px] text-center pt-4 pb-4">
            ...
            <p className="lg:block md:hidden  font-normal text-base text-[#686868] text-poppins">DashBroad</p>
          </button>
          ...
          <button className="hover:opacity-50 flex gap-[20px] text-center pt-4 pb-4">
            ...
            <p className="lg:block md:hidden font-normal text-base text-[#686868]">
              Recruitment
            </p>
          </button>
          ...
          <button className="hover:opacity-50 flex gap-[20px] text-center pt-4 pb-4">
            ...
            <p className=" lg:block md:hidden font-normal text-base text-[#686868]">Schedule</p>
          </button>
          ...
          <button className="hover:opacity-50 flex gap-[20px] text-center pt-4 pb-4">
            ...
            >
              ...
              />
              <path
                d="M16 18V15C16.0014 13.9833 15.7433 12.983 15.25 12.094C15.6933 11.9805 16.1568 11.9698 16.6049 12.0627C17.053 12.1556 17.474 12.3496 17.8357 12.6299C18.1974 12.9102 18.4903 13.2695 18.6921 13.6802C18.8939 14.091 18.9992 14.5424 19 15V18H16Z"
                fill="#B2B2B2"
              />
              <path
                d="M4.75 12.094C4.25675 12.983 3.9986 13.9833 4 15V18H1V15C0.999808 14.542 1.10446 14.0901 1.30595 13.6788C1.50743 13.2676 1.80039 12.9079 2.16238 12.6274C2.52437 12.3469 2.94578 12.153 3.39431 12.0605C3.84284 11.968 4.30658 11.9795 4.75 12.094Z"
                fill="#B2B2B2"
              />
              <rect x="6" y="11" width="8" height="7" rx="3" fill="#B2B2B2" />
            </svg>{" "}
            <p className="lg:block md:hidden font-normal text-base text-[#686868]">Employee</p>
          </button>
